...
- [2026-06-09/vulkan-whisper-fix.md](2026-06-09/vulkan-whisper-fix.md) - status: active; slug: `vulkan-whisper-fix`; date: 2026-06-09; scope: Vulkan Whisper hotfix after published `v0.8.2`; next action: package/choose final verified Vulkan runtime payload and resolve remaining latency SLO policy/performance gap.
