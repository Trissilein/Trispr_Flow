...
pub(crate) use tts_benchmark::run_tts_benchmark;
...
fn speak_tts_internal(
    ...
    let qwen3_runtime_config =
        crate::multimodal_io::resolve_qwen3_tts_runtime_config(&voice_settings);
        ...
        let run_chain = |selected_output_device: &str| {
            ...
            crate::multimodal_io::execute_tts_with_fallback(
                ...
                |provider| match provider {
                    ...
                    "qwen3_tts" => crate::multimodal_io::speak_qwen3_tts(
                        &text,
                        rate,
                        volume,
                        selected_output_device,
