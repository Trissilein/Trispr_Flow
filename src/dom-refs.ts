...
export const tabBtnTaskCapture = $("tab-btn-task-capture") as HTMLButtonElement | null;
export const tabBtnVideo = $("tab-btn-video") as HTMLButtonElement | null;
export const tabBtnAgent = $("tab-btn-agent") as HTMLButtonElement | null;
...
export const tabTaskCapture = $("tab-task-capture") as HTMLDivElement | null;
export const tabVideo = $("tab-video") as HTMLDivElement | null;
export const tabAgent = $("tab-agent") as HTMLDivElement | null;
...
export const ollamaModelDot = $("ollama-model-dot") as HTMLSpanElement | null;
export const gpuStatusDot = $("gpu-dot") as HTMLSpanElement | null;
export const gpuBackendCudaBtn = $("gpu-backend-cuda") as HTMLButtonElement | null;
export const gpuBackendVulkanBtn = $("gpu-backend-vulkan") as HTMLButtonElement | null;
export const gpuPurgeBtn = $("gpu-purge-btn") as HTMLButtonElement | null;
export const statusMessage = $("status-message");
// Engine-row telemetry (header rework)
export const gpuUtil = $("gpu-util") as HTMLSpanElement | null;
export const gpuVramTotal = $("gpu-vram-total") as HTMLSpanElement | null;
export const engineWhisperRow = $("engine-whisper") as HTMLDivElement | null;
export const engineWhisperModel = $("engine-whisper-model") as HTMLSpanElement | null;
export const engineWhisperVram = $("engine-whisper-vram") as HTMLSpanElement | null;
export const engineRefineRow = $("engine-refine") as HTMLDivElement | null;
export const engineRefineLabel = $("engine-refine-label") as HTMLSpanElement | null;
export const engineRefineModel = $("engine-refine-model") as HTMLSpanElement | null;
export const engineRefinePreset = $("engine-refine-preset") as HTMLButtonElement | null;
export const engineRefinePresetMenu = $("engine-refine-preset-menu") as HTMLUListElement | null;
export const engineRefineVram = $("engine-refine-vram") as HTMLSpanElement | null;
...
export const productModeControl = $("product-mode-control") as HTMLDivElement | null;
export const productModeTranscribeBtn = $("product-mode-transcribe-btn") as HTMLButtonElement | null;
export const productModeAssistantBtn = $("product-mode-assistant-btn") as HTMLButtonElement | null;
export const globalOnlineControl = $("global-online-control") as HTMLDivElement | null;
export const globalOnlineOfflineBtn = $("global-online-offline-btn") as HTMLButtonElement | null;
export const globalOnlineEnabledBtn = $("global-online-enabled-btn") as HTMLButtonElement | null;
...
export const ttsStopHotkey = $("tts-stop-hotkey") as HTMLInputElement | null;
export const ttsStopHotkeyRecord = $("tts-stop-hotkey-record") as HTMLButtonElement | null;
export const ttsStopHotkeyStatus = $("tts-stop-hotkey-status") as HTMLSpanElement | null;
...
export const diagnosticLoggingToggle = $("diagnostic-logging-toggle") as HTMLInputElement | null;
export const pttUseVadToggle = $("ptt-use-vad-toggle") as HTMLInputElement | null;
export const pttHotKeepalive = $("ptt-hot-keepalive") as HTMLInputElement | null;
export const pttHotKeepaliveValue = $("ptt-hot-keepalive-value");
...
export const vocabTermsList = $("vocab-terms-list") as HTMLDivElement | null;
export const vocabTermsCount = $("vocab-terms-count") as HTMLSpanElement | null;
export const vocabObservingList = $("vocab-observing-list") as HTMLDivElement | null;
...
export const aiFallbackPromptPreset = $("ai-fallback-prompt-preset") as HTMLSelectElement | null; // removed from HTML, will be null
export const promptPresetList = $("prompt-preset-list") as HTMLDivElement | null;
export const aiFallbackPresetNameField = $("ai-fallback-preset-name-field") as HTMLDivElement | null;
export const aiFallbackPresetNameInputWrap = $("ai-fallback-preset-name-input-wrap") as HTMLDivElement | null;
...
export const aiFallbackPromptPresetReset = $("ai-fallback-prompt-preset-reset") as HTMLButtonElement | null;
export const aiFallbackPromptPresetRevert = $("ai-fallback-prompt-preset-revert") as HTMLButtonElement | null;
export const aiFallbackPromptPresetDiscard = $("ai-fallback-prompt-preset-discard") as HTMLButtonElement | null;
...
export const overlayTtsStopEnabled = $("overlay-tts-stop-enabled") as HTMLInputElement | null;
export const overlayTtsStopShape = $("overlay-tts-stop-shape") as HTMLSelectElement | null;
export const overlayTtsStopColor = $("overlay-tts-stop-color") as HTMLInputElement | null;
...
export const workflowAgentLastHeard = $("workflow-agent-last-heard") as HTMLDivElement | null;
export const workflowAgentLastIntent = $("workflow-agent-last-intent") as HTMLDivElement | null;
export const workflowAgentLastReply = $("workflow-agent-last-reply") as HTMLDivElement | null;
export const workflowAgentLastGate = $("workflow-agent-last-gate") as HTMLDivElement | null;
export const workflowAgentAwaitingConfirmation = $("workflow-agent-awaiting-confirmation") as HTMLDivElement | null;
export const workflowAgentHandsFreeEnabled = $("workflow-agent-hands-free-enabled") as HTMLInputElement | null;
export const workflowAgentWakewords = $("workflow-agent-wakewords") as HTMLTextAreaElement | null;
export const workflowAgentWakewordAliases = $("workflow-agent-wakeword-aliases") as HTMLTextAreaElement | null;
...
export const voiceOutputDeviceSelect = $("voice-output-device-select") as HTMLSelectElement | null;
export const voiceOutputWindowsVoiceField = $("voice-output-windows-voice-field") as HTMLLabelElement | null;
export const voiceOutputWindowsVoiceSelect = $("voice-output-windows-voice-select") as HTMLSelectElement | null;
export const voiceOutputWindowsVoiceHint = $("voice-output-windows-voice-hint") as HTMLSpanElement | null;
export const voiceOutputFallbackVoiceField = $("voice-output-fallback-voice-field") as HTMLLabelElement | null;
export const voiceOutputFallbackVoiceSelect = $("voice-output-fallback-voice-select") as HTMLSelectElement | null;
export const voiceOutputFallbackVoiceHint = $("voice-output-fallback-voice-hint") as HTMLSpanElement | null;
export const voiceOutputPiperDownloadStatus = $("voice-output-piper-download-status") as HTMLDivElement | null;
export const voiceOutputPiperDownloadFill = $("voice-output-piper-download-fill") as HTMLDivElement | null;
export const voiceOutputPiperDownloadText = $("voice-output-piper-download-text") as HTMLSpanElement | null;
export const voiceOutputDefaultAvailability = $("voice-output-default-availability") as HTMLSpanElement | null;
export const voiceOutputFallbackAvailability = $("voice-output-fallback-availability") as HTMLSpanElement | null;
export const voiceOutputAutoLanguageVoiceField = $("voice-output-auto-language-voice-field") as HTMLDivElement | null;
export const voiceOutputAutoLanguageVoice = $("voice-output-auto-language-voice") as HTMLInputElement | null;
...
export const voiceOutputPiperGainDb = $("voice-output-piper-gain-db") as HTMLInputElement | null;
export const voiceOutputPiperGainDbValue = $("voice-output-piper-gain-db-value") as HTMLSpanElement | null;
