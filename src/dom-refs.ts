...
export const vocabLearningEnabled = $("vocab-learning-enabled") as HTMLInputElement | null;
export const vocabLearningConfig = $("vocab-learning-config") as HTMLDivElement | null;
export const vocabLearningSettings = $("vocab-learning-settings") as HTMLDivElement | null;
export const vocabAutoAdd = $("vocab-auto-add") as HTMLInputElement | null;
export const vocabThreshold = $("vocab-threshold") as HTMLInputElement | null;
export const vocabCandidatesStatus = $("vocab-candidates-status") as HTMLDivElement | null;
export const vocabResetCandidates = $("vocab-reset-candidates") as HTMLButtonElement | null;
...
// History controls
export const vocabSuggestionBanner = $("vocab-suggestion-banner") as HTMLDivElement | null;
