...
// Moved from event-listeners.ts (QW2) to break the circular dependency between
// settings.ts and event-listeners.ts. These are settings-panel render helpers
// and belong with the rest of the settings UI code.
